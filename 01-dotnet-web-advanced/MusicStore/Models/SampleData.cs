...
namespace MusicStore.Models
{
    public static class SampleData
    {
        ...
        private static Album[] GetAlbums(string imgUrl, Dictionary<string, Genre> genres, Dictionary<string, Artist> artists)
        {
            ...
            {
                new Album { Title = "The Best Of The Men At Work", Genre = genres["Pop"], Price = 6M, Artist = artists["Men At Work"], AlbumArtUrl = imgUrl },
                new Album { Title = "...And Justice For All", Genre = genres["Metal"], Price = 5M, Artist = artists["Metallica"], AlbumArtUrl = imgUrl },
                new Album { Title = "עד גבול האור", Genre = genres["World"], Price = 8.99M, Artist = artists["אריק אינשטיין"], AlbumArtUrl = imgUrl },
                new Album { Title = "Black Light Syndrome", Genre = genres["Rock"], Price = 4M, Artist = artists["Terry Bozzio, Tony Levin & Steve Stevens"], AlbumArtUrl = imgUrl },
                new Album { Title = "10,000 Days", Genre = genres["Rock"], Price = 8.99M, Artist = artists["Tool"], AlbumArtUrl = imgUrl },
                new Album { Title = "11i", Genre = genres["Electronic"], Price = 3M, Artist = artists["Supreme Beings of Leisure"], AlbumArtUrl = imgUrl },
                new Album { Title = "1960", Genre = genres["Indie"], Price = 1M, Artist = artists["Soul-Junk"], AlbumArtUrl = imgUrl },
                new Album { Title = "4x4=12 ", Genre = genres["Electronic"], Price = 2M, Artist = artists["deadmau5"], AlbumArtUrl = imgUrl },
                ...
                new Album { Title = "A Lively Mind", Genre = genres["Electronic"], Price = 10M, Artist = artists["Paul Oakenfold"], AlbumArtUrl = imgUrl },
                new Album { Title = "A Matter of Life and Death", Genre = genres["Rock"], Price = 11M, Artist = artists["Iron Maiden"], AlbumArtUrl = imgUrl },
                new Album { Title = "A Real Dead One", Genre = genres["Metal"], Price = 12M, Artist = artists["Iron Maiden"], AlbumArtUrl = imgUrl },
